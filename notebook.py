...
get_ipython().system('pip3 install -U transformers')
...
model.push_to_hub("reeteshsingh/distilbert-goodreads-genres")
tokenizer.push_to_hub("reeteshsingh/distilbert-goodreads-genres")

# Reinitialize W&B to record the link (since wandb.finish() was called earlier)
wandb.init(project="huggingface", name="distilbert-run-1", resume="allow")
wandb.run.summary["mlops-assignment2"] = \
    "https://huggingface.co/reeteshsingh/distilbert-goodreads-genres"
wandb.finish()
